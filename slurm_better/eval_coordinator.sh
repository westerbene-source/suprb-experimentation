...
#   zellij
#   bash slurm_better/eval_coordinator.sh --optimizer spea2 --dataset _________ --n-workers 25 --node oc-compute04 --project-dir /home/wolfbene/run7/suprb-experimentation
set -e
